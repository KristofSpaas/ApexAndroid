package com.groep9.apex.apexandroid.DrawerMenu;
...
public class DrawerMenuItemAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {
            ...
            ImageView ivHeader = (ImageView) convertView.findViewById(R.id.iv_header);
            ivHeader.setImageResource(R.drawable.logo);
        } else {
